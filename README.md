...
2. **Install dependencies**:
   ...
   ```
   *(Note: The `onnxruntime-directml` dependency enables native DirectML hardware acceleration on Windows, utilizing compatible AMD, Intel, and NVIDIA GPUs. It will fall back to CPU if not supported).*
