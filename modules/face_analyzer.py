...
class FaceAnalyzer:
    ...
    def initialize(self):
        ...
        try:
            ...
            # DirectML Execution Provider is DmlExecutionProvider
            providers = ['DmlExecutionProvider', 'CPUExecutionProvider']
            logger.info(f"Setting ONNX Runtime providers to: {providers}")
            
            # Initialize model
            # buffalo_l is the default, buffalo_s is the fast version
            ...
            logger.info("InsightFace successfully initialized with DirectML/CPU fallback.")
